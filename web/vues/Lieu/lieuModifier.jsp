...
<html>
 ...
 <form class="form-inline" action="lieuModifier" method="POST">
               <label for="id">id </label>
                <input id="id" type="text" name="id"  size="50" maxlength="3" value="<%out.println(leLieu.getId());%>" readonly>
                </br>
        ...
        <label for="commentaire"> Commentaire </label>
                <input id="commentaire" type="text" name="commentaire"  size="50" maxlength="255" value="<%out.println(leLieu.getCommentaires());%>">
                </br>
